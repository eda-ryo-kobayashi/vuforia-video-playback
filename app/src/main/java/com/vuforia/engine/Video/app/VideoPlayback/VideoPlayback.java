...
import com.vuforia.engine.Video.ui.SampleAppMenu.SampleAppMenu;
import com.vuforia.engine.Video.ui.SampleAppMenu.SampleAppMenuGroup;
import com.vuforia.engine.Video.ui.SampleAppMenu.SampleAppMenuInterface;
    ...
    SampleApplicationControl, SampleAppMenuInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mMovieName[STONES] = "VideoPlayback/sample_green.mp4";
    ...
    private void loadTextures()
    {
        mTextures.add(Texture.loadTextureFromApk(
            "VideoPlayback/SampleVideoPreview.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk(
            "VideoPlayback/SampleVideoPreview.png", getAssets()));
