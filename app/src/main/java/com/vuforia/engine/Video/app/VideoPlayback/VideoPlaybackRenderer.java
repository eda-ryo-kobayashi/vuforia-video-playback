...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl {
    ...
    private int videoPlaybackChromaKeyHandle = 0;
    ...
    WeakReference<VideoPlayback> mActivityRef;
    ...
    void initRendering() {
        ...
        videoPlaybackChromaKeyHandle = GLES20.glGetUniformLocation(
                videoPlaybackShaderID, "chromaKey");
    ...
    public void renderFrame(State state, float[] projectionMatrix) {
        ...
        for (TrackableResult trackableResult : trackableResultList) {
            ...
            // the actual contents
            {
                ...
                GLES20.glUniform3fv(videoPlaybackChromaKeyHandle, 1, chromaKeyColor, 0);
